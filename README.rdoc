...
== Usage
===Translation
GetText translate messages which _("")

- _: Basic translation method
  Most basic method to translate the message.
    _("Hello")

The gettext methods comes in 3 combinable flavours
- n: Pluralized
...
- N_, Nn_: Nothing to do, but extract with rgettext as the msgid.
    fruit = N_("Apple")  # Nothing to do
    _(fruit)             # Translate the variable "fruit" here.
