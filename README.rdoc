...
Rails / ActiveRecord specific code now lives in locale_rails[http://github.com/locale_rails], gettext_rails[http://github.com/gettext_rails] and gettext_activerecord[http://github.com/gettext_activerecord].
